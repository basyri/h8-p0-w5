...
customer berkurang 15 menit. 
Begitu seterusnya sampai waktunya habis .Customer masih bisa memesan/mengambil 
makanan selama waktunya belum 0.
...
makanan dalam waktu yang diberikan. 
...
function makanTerusRekursif(waktu) {
    ...
    if (waktu === 0) {
        ...
        counter = 1 + makanTerusRekursif(waktu - 15)
        return counter
    }
    // counter++
...
console.log(makanTerusRekursif(0)); // 00